    ...
    return (
        ...
        <div className='h-screen flex items-center justify-center bg-black px-[20px] '>
            <div className='bg-white  rounded-md md:w-[451px] md:h-[316px] flex flex-col space-y-[32px] py-[20px] px-[28px] mx-auto justify-center items-center'>
                <Image src={icon} width={64} height={64} alt="icon" className='mx-auto' />
                ...
                <div className='flex  space-x-[24px]  '>
                    <div className='w-[150px] h-[40px]   cursor-pointer bg-[#fff] text-[#323232]  flex items-center justify-center text-center rounded-md leading-[24px] border-[1px] border-[#cdced9]  ' onClick={() => {
                        setOpen(false)
                    }}> Cancel </div>
