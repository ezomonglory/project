                ...
                {open ? <CourseModal text="update" texting="updating" user={User} Attendance={checkBoxList} setOpen={setOpen} color="bg-[#183DA7]" icon="/image/Update Course.svg" /> :
                    ...
                    < >
                        ...
                        <div className='bg-[#F4F4F4] w-full py-[32px] md:px-[40px] px-[16px] h-screen '>
                            <div className=' flex flex-col space-y-[8px] md:space-y-[8px] pb-[16px] md:pb-[32px] justify-between items-start relative mb-[32px] '>
                            ...
                            <>
                                {
                                    load ? <div className='flex items-center justify-center h-full w-full'>
                                        ...
                                        <div className='w-screen md:w-full flex ml-[-16px] md:ml-0  h-[65vh] bg-transparentoverflow-scroll scroll-hidden overflow-x-scroll scroll-hidden '>
