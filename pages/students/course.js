...
//                 {open ? <CourseModal text="delete" ID={ID} Attendance={Attendance} setAttendance={setAttendance}  texting="removal" color="bg-red-600" setOpen={setOpen} icon="/image/Danger Circle.svg" /> :
