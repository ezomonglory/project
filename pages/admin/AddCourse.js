...
const AddCourse = () => {
	...
	const getCourse = async (course) => {
		...
		setLoad(true);
		await axios
			.get(`https://attendx-2hi6.onrender.com/course/all-courses`)
			.then((res) => {
			...
			<main>			
				...
				{open ? (
					<CourseModal
						...
						user={User}
						courses={Attendance}
						Attendance={checkBoxList}
						setOpen={setOpen}
						color='bg-[#183DA7]'
						icon='image/Notebook.svg'
					/>
				) : (
					<DashboardLayout>
						<div className='pb-[24px] md:pb-[32px]  gap-[4px]  flex-col  flex justify-between items-start'>
							<h1 className='text-[#141414] font-[500] text-[20px] mt-[8px] md:mt-0 md:text-[30px] leading-[28px]  md:leading-[38px] medium  '>
								{" "}
								Add new course{" "}
							</h1>
							...
							<div className='flex   items-start gap-[8px]'>
								...
								<p className='text-[#141414]'>Add Courses</p>
							</div>
						...
						<>
							...
							<div
								className='w-[150px] mt-[32px] absolute  bottom-2 md:bottom-[25px]'
								onClick={() => {
									setOpen(true);
								}}
							>
